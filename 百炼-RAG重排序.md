...
请先[获取API Key](https://help.aliyun.com/zh/model-studio/get-api-key)并[配置API Key到环境变量](https://help.aliyun.com/zh/model-studio/configure-api-key-through-environment-variables)。如需使用 SDK，请[安装SDK](https://help.aliyun.com/zh/model-studio/install-sdk)。
...
参见[排序模型（Rerank）](https://help.aliyun.com/zh/model-studio/text-rerank-api)。
